  ...
  let page = 1;
    ...
    .then(result => {
      ...
      for (i = 0; i < allDetails.length; i++) {
        ...
        if(details[8].value && details[8].value.index === 3) {
          ...
          columns[8].children[0].style.display = "block";
            ...
            Cognito.prefill(
              ...
              "MondaycomItemID": id,
              "ProjectID": details[0].value ? details[0].value : '',
              "ProjectName": details[1].value ? details[1].value : ''
              }, 
            revisionFrame);  
        	});
        }
        ...
        let documentTypes = '';
       	let j;
        const allDocumentTypes = details[5].value ? details[5].value.text.split(',') : [];
        for(j = 0; j < allDocumentTypes.length; j++) {
        	documentTypes = documentTypes + `<li>${allDocumentTypes[j]}</li>`
        }
        
        if (details[7].value === 'Working On It') {
        	columns[7].children[0].innerText = `Working on it`;
          columns[7].children[1].style.display = "none";
        } else {
          columns[7].children[0].style.display = "none";
          columns[7].children[1].href = `${details[7].value}`;
        }
        ...
        columns[2].children[0].innerHTML = documentTypes;
        columns[3].children[0].innerText = `${details[2].value ? projectStatus[details[2].value.index] : ''}`;
        columns[4].children[0].innerText = `${details[3].value ? details[3].value.date : ''}`;
        columns[5].children[0].innerText = `${details[4].value ? details[4].value.date : ''}`;
        columns[6].children[0].innerText = `${details[6].value ? details[6].value : ''}`;
